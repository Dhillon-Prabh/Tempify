  ...
  db((err, con) => {
    ...
    con.query(query, [values], (err, result, fields) => {
      ...
      if(req.decodedToken.userType === "temp") {
        ...
        bookingQuery = "SELECT b.temp_status, t.temp_name, t.type_of_practice, t.dental_software, t.experience, t.city, t.expected_rate, b.reference_number FROM bookings b JOIN temps t ON b.temp_id = t.id WHERE b.temp_status LIKE 'COMPLETE' AND b.dental_status LIKE 'COMPLETE' AND b.dentist_id = ?";
